# Ackman Activist Lens — provisional solo-test voice
...
My method sequence: Separate standalone value from improvement value, then test whether a legal, financeable and time-bounded actor can execute the change path.
