...
export const FUND_REGISTRY = Object.freeze({
  ...
  SOXX: { issuer: "ishares", name: "iShares Semiconductor ETF", product_id: "239705", cusip: "464287523" },
  IYW: { issuer: "ishares", name: "iShares U.S. Technology ETF", product_id: "239522", cusip: "464287721" },
  IYF: { issuer: "ishares", name: "iShares U.S. Financials ETF", product_id: "239508", cusip: "464287788" },
  IYH: { issuer: "ishares", name: "iShares U.S. Healthcare ETF", product_id: "239511", cusip: "464287762" },
  IYE: { issuer: "ishares", name: "iShares U.S. Energy ETF", product_id: "239507", cusip: "464287796" },
  IBB: { issuer: "ishares", name: "iShares Biotechnology ETF", product_id: "239699", cusip: "464287556" },
  IGV: { issuer: "ishares", name: "iShares Expanded Tech-Software Sector ETF", product_id: "239771", cusip: "464287515" },
  ITB: { issuer: "ishares", name: "iShares U.S. Home Construction ETF", product_id: "239512", cusip: "464288752" },
  IWF: { issuer: "ishares", name: "iShares Russell 1000 Growth ETF", product_id: "239706", cusip: "464287614" },
  IWD: { issuer: "ishares", name: "iShares Russell 1000 Value ETF", product_id: "239708", cusip: "464287598" },
  IJH: { issuer: "ishares", name: "iShares Core S&P Mid-Cap ETF", product_id: "239763", cusip: "464287507" },
  IJR: { issuer: "ishares", name: "iShares Core S&P Small-Cap ETF", product_id: "239774", cusip: "464287804" },
  IEFA: { issuer: "ishares", name: "iShares Core MSCI EAFE ETF", product_id: "244049", cusip: "46432F842" },
  EEM: { issuer: "ishares", name: "iShares MSCI Emerging Markets ETF", product_id: "239637", cusip: "464287234" },
  ...
  XLK: { issuer: "ssga", name: "Technology Select Sector SPDR Fund", slug: "xlk" },
  XLF: { issuer: "ssga", name: "Financial Select Sector SPDR Fund", slug: "xlf" },
  XLE: { issuer: "ssga", name: "Energy Select Sector SPDR Fund", slug: "xle" },
  XLV: { issuer: "ssga", name: "Health Care Select Sector SPDR Fund", slug: "xlv" },
  XLI: { issuer: "ssga", name: "Industrial Select Sector SPDR Fund", slug: "xli" },
  XLY: { issuer: "ssga", name: "Consumer Discretionary Select Sector SPDR Fund", slug: "xly" },
  XLP: { issuer: "ssga", name: "Consumer Staples Select Sector SPDR Fund", slug: "xlp" },
  XLU: { issuer: "ssga", name: "Utilities Select Sector SPDR Fund", slug: "xlu" },
  XLB: { issuer: "ssga", name: "Materials Select Sector SPDR Fund", slug: "xlb" },
  XLRE: { issuer: "ssga", name: "Real Estate Select Sector SPDR Fund", slug: "xlre" },
  XLC: { issuer: "ssga", name: "Communication Services Select Sector SPDR Fund", slug: "xlc" },
