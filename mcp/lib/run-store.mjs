...
export function statusSnapshot(run) {
  ...
  return {
    ...
    selected_analysts: Array.isArray(run.tasks) ? run.tasks : [],
    ...
    verification_scope: gate.verification_scope,
    adversarial_verification: gate.adversarial_verification,
    verifier_verdict_count: verifierVerdicts.length,
    verifier_required: gate.verifier_audit.required,
    verifier_zero: gate.verifier_audit.verifier_zero,
    verifier_expected_count: gate.verifier_audit.expected_verdict_count,
    verifier_material_claim_count: gate.verifier_audit.material_claim_count,
    verifier_missing_count: gate.verifier_audit.missing.length,
    verifier_non_clean_count: gate.verifier_audit.non_clean.length,
    verifier_policy_id: gate.verifier_audit.policy_id,
