...
Status: package/plugin version `0.9.0-solo-test.2`, channel `solo_test`; verifier contracts implemented,
...
current worktree is version 0.9.0-solo-test.2 and has no approved physical production release
