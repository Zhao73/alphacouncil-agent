...
> sources alone, and `npm test` is green at 955 tests. Measured against live grounding across
> eight symbols, twenty-six of twenty-seven seats reach a stance somewhere with no contract
> failures; the twenty-seventh declines by authored construction and says why.
