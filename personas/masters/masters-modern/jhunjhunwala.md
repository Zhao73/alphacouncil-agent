---json
{
  ...
  "philosophy_tags": [
    ...
    "promoter-minority-alignment",
    "growth-with-cash-quality",
    "concentrate-only-after-governance"
  ],
  "era": "1980s-2022",
  "holding_period": "multi-year through the structural growth cycle, while governance and cash quality remain intact",
  "disqualifiers": [
    "the India growth thesis is macro-level only and has no evidence that this company captures the penetration or productivity gain",
    "promoter control, related-party transactions or capital allocation leave minority shareholders without a defensible share of value",
    "reported growth does not convert into operating cash while leverage, pledging, dilution or working-capital dependence rises"
  ],
