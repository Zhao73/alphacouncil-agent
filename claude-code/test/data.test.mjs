...
isolateHome();
const data = await import("../lib/data.mjs");
const { computeTechnicals } = await import("../lib/technicals.mjs");
const { setFetch } = await import("../lib/http.mjs");
const { evaluateLenses } = await import("../lib/lenses.mjs");
